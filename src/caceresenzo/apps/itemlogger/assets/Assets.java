package caceresenzo.apps.itemlogger.assets;

import caceresenzo.frameworks.assets.FrameworkAssets;

public class Assets extends FrameworkAssets {
	...
	public static final String ICON_IN_CONSTRUCTION_32PX = ICONS_BASE_PATH + "/icon-in-construction-32px.png";
	...
	public static final String ICON_PRINT_32PX = ICONS_BASE_PATH + "/icon-print-32px.png";
